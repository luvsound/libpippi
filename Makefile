...
all:
	...
	gcc -std=c99 -Wall -pedantic -lm -Isrc -Ivendor examples/memory_pool.c src/memorypool.c src/sineosc.c src/pulsar.c src/soundfile.c src/interpolation.c src/window.c src/wavetable.c src/pippicore.c -o build/memorypool
	./build/memorypool
